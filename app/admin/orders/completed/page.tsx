      ...
      <div className="flex items-center justify-center py-24">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="font-poppins text-sm text-dark/40">
            Chargement des commandes livrées…
          </p>
        </div>
      </div>
    );
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <div className="flex items-center gap-1.5 font-poppins text-xs text-dark/40 mb-2">
            ...
            <span className="text-dark/60">Livrées</span>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-emerald-500">
          ...
          <p className="font-poppins text-3xl font-bold text-emerald-500">
            {stats.delivered}
          </p>
        </div>
      ...
      {completedOrders.length > 0 && (
        <div className="flex items-center gap-3 px-4 py-3 mb-6 bg-emerald-50 border border-emerald-100 rounded-xl">
          <svg
          ...
          <p className="font-poppins text-sm text-emerald-700">
            <strong>{completedOrders.length}</strong> commande
            {completedOrders.length > 1 ? "s" : ""} livrée
            {completedOrders.length > 1 ? "s" : ""} avec succès.
          </p>
        </div>
      )}
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="ml-auto font-poppins text-xs text-dark/40 hidden sm:block">
          {completedOrders.length} commande
          {completedOrders.length !== 1 ? "s" : ""} livrée
        ...
        {completedOrders.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-14 text-center">
            <div className="mx-auto w-16 h-16 rounded-full bg-dark/5 flex items-center justify-center mb-4">
              <svg
                className="w-8 h-8 text-dark/20"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
                      ...
                      <td className="px-4 py-3.5">
                        <div className="min-w-0">
                          ...
                          <p className="font-poppins text-xs text-dark/40 truncate max-w-36">
                            {addr.phone || o.userEmail}
                          </p>
                        </div>
                      </td>
                      {/* Address */}
                      <td className="hidden lg:table-cell px-4 py-3.5">
                        <p className="font-poppins text-sm text-dark/70 truncate max-w-48">
        ...
        {completedOrders.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-10 text-center">
            <div className="mx-auto w-14 h-14 rounded-full bg-dark/5 flex items-center justify-center mb-3">
              <svg
                className="w-7 h-7 text-dark/20"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="inline-flex items-center gap-1.5 font-poppins text-xs font-medium px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-600 shrink-0">
