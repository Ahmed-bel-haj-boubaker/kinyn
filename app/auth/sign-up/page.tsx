      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-12 text-center">
          <Link href="/" aria-label="Retour à l'accueil">
            <h2 className="font-family-poppins text-5xl tracking-wider text-white xl:text-6xl">
              KINYN
            </h2>
          </Link>
      ...
      <div className="flex w-full items-center justify-center px-6 py-12 lg:w-1/2 lg:px-16 xl:px-24">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center lg:hidden">
            <Link href="/" aria-label="Retour à l'accueil">
              <h2 className="font-erotique text-4xl tracking-wider text-dark">
                KINYN
              </h2>
            </Link>
          </div>
          ...
          <div className="rounded-2xl bg-white/50 px-8 py-10 shadow-lg shadow-dark/5 backdrop-blur-sm sm:px-10">
            <h1 className="font-erotique text-3xl text-dark">Créer un compte</h1>
