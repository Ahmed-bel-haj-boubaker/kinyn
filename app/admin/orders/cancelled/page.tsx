      ...
      <div className="flex items-center justify-center py-24">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="font-poppins text-sm text-dark/40">
            Chargement des commandes annulées…
          </p>
        </div>
      </div>
    );
    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-red-500">
          ...
          <p className="font-poppins text-3xl font-bold text-red-500">
            {stats.cancelled}
          </p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border-l-4 border-gray-400">
          ...
          <p className="font-poppins text-3xl font-bold text-gray-500">
            {stats.returned}
          </p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4">
          <p className="font-poppins text-[10px] font-semibold text-red-400 uppercase tracking-wider mb-1">
            Revenu perdu
          </p>
          <p className="font-poppins text-2xl font-bold text-red-400">
      ...
      {cancelledOrders.length > 0 && (
        <div className="flex items-center gap-3 px-4 py-3 mb-6 bg-red-50 border border-red-100 rounded-xl">
          <svg
          ...
          <p className="font-poppins text-sm text-red-600">
            <strong>{cancelledOrders.length}</strong> commande
            {cancelledOrders.length > 1 ? "s" : ""} annulée
            {cancelledOrders.length > 1 ? "s" : ""} ou retournée
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="ml-auto font-poppins text-xs text-dark/40 hidden sm:block">
          {cancelledOrders.length} commande
          {cancelledOrders.length !== 1 ? "s" : ""}
        </span>
      </div>
      ...
      <div className="hidden md:block">
        {cancelledOrders.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-14 text-center">
            ...
            <p className="font-poppins text-sm text-dark/40">
              Aucune annulation ou retour enregistré.
            </p>
          </div>
        ) : (
                ...
                {cancelledOrders.map((o) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Amount */}
                      <td className="px-4 py-3.5">
                        <span className="font-poppins text-sm font-semibold text-dark/50 line-through">
                      ...
                      <td className="px-6 py-3.5 text-right">
                        ...
                        >
                          <button
                            type="button"
                            onClick={() => handleView(o)}
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-white font-poppins text-xs font-medium text-dark/60 hover:text-dark hover:border-gray-300 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-primary/10"
                          >
                            <svg
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-50">
                  ...
                  <span className="font-poppins text-sm font-bold text-dark/50 line-through">
                    {o.totalAmount.toLocaleString("fr-FR", {
                      minimumFractionDigits: 2,
                    })}{" "}
                    TND
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      onClick={() => handleView(o)}
                      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border border-gray-200 bg-white font-poppins text-xs font-medium text-dark/60 hover:text-dark transition-colors duration-150 focus:outline-none"
                    >
                      <svg
                        className="w-3 h-3"
                        fill="none"
