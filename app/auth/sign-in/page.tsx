...
function SignInPageInner() {
  ...
  return (
    <main className="flex h-screen max-h-screen w-full overflow-hidden bg-background">
      ...
      {/* ───────── Right — Sign-in Form ───────── */}
      <div className="flex h-full w-full overflow-y-auto lg:w-1/2">
        <div className="m-auto w-full max-w-2xl px-6 py-12 lg:px-16 xl:px-24">
          {/* Mobile brand */}
